...
public class AppInfoUtil {
     ...
     * @param context
     */
    public static void getAllProgramInfo(List<AppListBean> allApplist,
                                         Context context) {
     ...
     * @param context
     */
    public static void getSysProgramInfo(List<AppListBean> allApplist,
                                         Context context) {
     ...
     * @param context
     */
    public static void getNoSysProgramInfo(List<AppListBean> allApplist,
                                           Context context) {
     ...
     */
    public static void getAllProgramInfo(List<AppListBean> applist,
        ...
        for (int j = 0; j < installAppList.size(); j++) {
            ...
            AppListBean tmpInfo = new AppListBean();
     ...
     * @return
     */
    public static List<AppListBean> getAllSystemProgramInfo(Context context) {
        List<AppListBean> systemAppList = new ArrayList<AppListBean>();
     ...
     * @return
     */
    public static List<AppListBean> getAllNonsystemProgramInfo(Context context) {
        List<AppListBean> nonsystemAppList = new ArrayList<AppListBean>();
